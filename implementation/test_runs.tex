...
\fig[0.7]{implementation/TopcAutoBetas.pdf}{Integrated autocorrelation time $\tau_{int}$ for fixed values of $N_{corr}=200$ and $N_{hit} = 10$. The different data series represent different inverse coupling values, the system sizes are the ones of \cref{runs:ensembles}. }{fig:autobetas}
