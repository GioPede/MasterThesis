...
\beq
    ...
    \label{val:tops}
\eeq 
This is compatible with the value in \cite{shindler_nucleon_2015} of  $\chi^{\frac{1}{4}}_{ref} = 195.9(4.9)~\text{MeV} $. \NOTE{PROBLEMS; B=6.0 POINT; MATHIAS}
